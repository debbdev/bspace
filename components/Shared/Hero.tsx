...
function Hero() {
  ...
  return (
    <section
      className={`${theme === "light" ? "bg-neutral-700 text-light-900" : "bg-neutral-600 text-light-900"} h-96 w-full bg-hero-image bg-cover bg-center bg-no-repeat pb-16 pt-24 bg-blend-multiply max-sm:h-full  lg:h-[26rem]`}
    >
      ...
      <div className="flex w-full flex-wrap gap-4  py-3 pl-5 pr-4 sm:gap-1 sm:px-10 lg:flex-nowrap lg:gap-40 lg:pl-44 lg:pr-0">
        <div className="text-dark100_light900 flex h-10 w-full items-center py-2 sm:w-full lg:w-[30rem]">
          <div className="flex size-10 items-center justify-center rounded-l-md rounded-r-none bg-primary-500">
            <Image
        ...
        <button className="mt-2 h-10 w-full rounded-md bg-primary-500 px-5 py-2 sm:w-full lg:mt-0 lg:w-60">
          Search
        </button>
      </div>
